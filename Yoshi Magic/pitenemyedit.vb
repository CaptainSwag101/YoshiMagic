Public Class pitenemyedit
    ...
    Private Sub PITEnemyEditor_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        For a = 0 To enemies
            FileGet(1, nameindex(a), eddata + (&H2C * a) + 1)
            FileGet(1, namepointer(a), edname + (nameindex(a) << 2) + 1)
            Seek(1, edname + namepointer(a) + 1)
            For b = 0 To 20
                FileGet(1, letter) 'Nametxt(a, b)) ', edname + namepointer(a) + b + 1)
                EnemyName(a) += Chr(letter) 'Nametxt(a, b))
            Next
